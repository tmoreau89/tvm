...
proc create_root_design { parentCell inp_part wgt_part out_part inp_bus_width inp_mem_depth wgt_bus_width wgt_mem_depth out_bus_width out_mem_depth } {
  ...
  set_property -dict [ list \
   CONFIG.C_M_AXI_DATA_PORT_CACHE_VALUE {"0011"} \
   CONFIG.C_M_AXI_UOP_PORT_CACHE_VALUE {"0011"} \
 ] $compute_0
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axi_smc_0_M00_AXI [get_bd_intf_pins axi_smc_0/M00_AXI] [get_bd_intf_pins ps_e_0/S_AXI_HP0_FPD]
  connect_bd_intf_net -intf_net axi_smc_1_M00_AXI [get_bd_intf_pins axi_smc_1/M00_AXI] [get_bd_intf_pins ps_e_0/S_AXI_HP1_FPD]
  connect_bd_intf_net -intf_net axi_smc_2_M00_AXI [get_bd_intf_pins axi_smc_2/M00_AXI] [get_bd_intf_pins ps_e_0/S_AXI_HP2_FPD]
  connect_bd_intf_net -intf_net axi_smc_3_M00_AXI [get_bd_intf_pins axi_smc_3/M00_AXI] [get_bd_intf_pins ps_e_0/S_AXI_HP3_FPD]
  ...
  connect_bd_intf_net -intf_net fetch_0_m_axi_ins_port [get_bd_intf_pins axi_smc_0/S00_AXI] [get_bd_intf_pins fetch_0/m_axi_ins_port]
  ...
  connect_bd_intf_net -intf_net load_0_m_axi_data_port [get_bd_intf_pins axi_smc_1/S00_AXI] [get_bd_intf_pins load_0/m_axi_data_port]
  ...
  connect_bd_intf_net -intf_net compute_0_m_axi_uop_port [get_bd_intf_pins axi_smc_0/S01_AXI] [get_bd_intf_pins compute_0/m_axi_uop_port]
  connect_bd_intf_net -intf_net compute_0_m_axi_data_port [get_bd_intf_pins axi_smc_2/S00_AXI] [get_bd_intf_pins compute_0/m_axi_data_port]
  ...
  connect_bd_intf_net -intf_net store_0_m_axi_data_port [get_bd_intf_pins axi_smc_3/S00_AXI] [get_bd_intf_pins store_0/m_axi_data_port]
  ...
  connect_bd_net -net proc_sys_reset_peripheral_aresetn [get_bd_pins axi_smc_0/aresetn] [get_bd_pins axi_smc_1/aresetn] [get_bd_pins axi_smc_2/aresetn] [get_bd_pins axi_smc_3/aresetn] [get_bd_pins axi_xbar/M00_ARESETN] [get_bd_pins axi_xbar/M01_ARESETN] [get_bd_pins axi_xbar/M02_ARESETN] [get_bd_pins axi_xbar/M03_ARESETN] [get_bd_pins axi_xbar/S00_ARESETN] [get_bd_pins compute_0/ap_rst_n] [get_bd_pins fetch_0/ap_rst_n] [get_bd_pins g2l_queue/s_aresetn] [get_bd_pins g2s_queue/s_aresetn] [get_bd_pins gemm_queue/s_aresetn] [get_bd_pins l2g_queue/s_aresetn] [get_bd_pins load_0/ap_rst_n] [get_bd_pins load_queue/s_aresetn] [get_bd_pins proc_sys_reset/peripheral_aresetn] [get_bd_pins s2g_queue/s_aresetn] [get_bd_pins store_0/ap_rst_n] [get_bd_pins store_queue/s_aresetn]
  connect_bd_net -net ps_clk_net [get_bd_pins pll_clk/clk_in1] [get_bd_pins ps_e_0/pl_clk0]
  connect_bd_net -net ps_e_0_clk [get_bd_pins axi_smc_0/aclk] [get_bd_pins axi_smc_1/aclk] [get_bd_pins axi_smc_2/aclk] [get_bd_pins axi_smc_3/aclk] [get_bd_pins axi_xbar/ACLK] [get_bd_pins axi_xbar/M00_ACLK] [get_bd_pins axi_xbar/M01_ACLK] [get_bd_pins axi_xbar/M02_ACLK] [get_bd_pins axi_xbar/M03_ACLK] [get_bd_pins axi_xbar/S00_ACLK] [get_bd_pins compute_0/ap_clk] [get_bd_pins fetch_0/ap_clk] [get_bd_pins g2l_queue/s_aclk] [get_bd_pins g2s_queue/s_aclk] [get_bd_pins gemm_queue/s_aclk] [get_bd_pins l2g_queue/s_aclk] [get_bd_pins load_0/ap_clk] [get_bd_pins load_queue/s_aclk] [get_bd_pins pll_clk/clk_out1] [get_bd_pins proc_sys_reset/slowest_sync_clk] [get_bd_pins ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins ps_e_0/saxihp0_fpd_aclk] [get_bd_pins ps_e_0/saxihp1_fpd_aclk] [get_bd_pins ps_e_0/saxihp2_fpd_aclk] [get_bd_pins ps_e_0/saxihp3_fpd_aclk] [get_bd_pins s2g_queue/s_aclk] [get_bd_pins store_0/ap_clk] [get_bd_pins store_queue/s_aclk]
  connect_bd_net -net ps_e_0_reset [get_bd_pins pll_clk/resetn] [get_bd_pins proc_sys_reset/ext_reset_in] [get_bd_pins ps_e_0/pl_resetn0]

  # Create address segments
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces fetch_0/Data_m_axi_ins_port] [get_bd_addr_segs ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_ps_e_0_HP0_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces load_0/Data_m_axi_data_port] [get_bd_addr_segs ps_e_0/SAXIGP3/HP1_DDR_LOW] SEG_ps_e_0_HP1_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces compute_0/Data_m_axi_uop_port] [get_bd_addr_segs ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_ps_e_0_HP0_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces compute_0/Data_m_axi_data_port] [get_bd_addr_segs ps_e_0/SAXIGP4/HP2_DDR_LOW] SEG_ps_e_0_HP2_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces store_0/Data_m_axi_data_port] [get_bd_addr_segs ps_e_0/SAXIGP5/HP3_DDR_LOW] SEG_ps_e_0_HP3_DDR_LOW
  ...
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces compute_0/Data_m_axi_data_port] [get_bd_addr_segs ps_e_0/SAXIGP4/HP2_LPS_OCM] SEG_ps_e_0_HP2_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs compute_0/Data_m_axi_data_port/SEG_ps_e_0_HP2_LPS_OCM]

  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces compute_0/Data_m_axi_uop_port] [get_bd_addr_segs ps_e_0/SAXIGP2/HP0_LPS_OCM] SEG_ps_e_0_HP0_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs compute_0/Data_m_axi_uop_port/SEG_ps_e_0_HP0_LPS_OCM]

  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces fetch_0/Data_m_axi_ins_port] [get_bd_addr_segs ps_e_0/SAXIGP2/HP0_LPS_OCM] SEG_ps_e_0_HP0_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs fetch_0/Data_m_axi_ins_port/SEG_ps_e_0_HP0_LPS_OCM]

  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces load_0/Data_m_axi_data_port] [get_bd_addr_segs ps_e_0/SAXIGP3/HP1_LPS_OCM] SEG_ps_e_0_HP1_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs load_0/Data_m_axi_data_port/SEG_ps_e_0_HP1_LPS_OCM]

  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces store_0/Data_m_axi_data_port] [get_bd_addr_segs ps_e_0/SAXIGP5/HP3_LPS_OCM] SEG_ps_e_0_HP3_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs store_0/Data_m_axi_data_port/SEG_ps_e_0_HP3_LPS_OCM]
...
create_root_design "" $inp_part $wgt_part $out_part $inp_bus_width \
